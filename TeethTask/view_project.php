			...
			<div class="callout callout-info">
				<div class="col-md-12">
					<div class="row">
						<div class="col-sm-6">
							<dl>
								<dt><b class="border-bottom border-primary">Patient Name</b></dt>
						...
						<div class="col-md-6">
							...
							<dl>
								<dt><b class="border-bottom border-primary">Doctor</b></dt>
								<dd>
									...
									<?php else: ?>
										<small><i>Doctor Deleted from Database</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
