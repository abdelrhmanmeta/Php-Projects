				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" step="any" class="form-control" name="major">
							</div>							
					</div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$doctor = $conn->query("SELECT * FROM doctor_list order by id asc");
								...
								<tr>
									...
									<td class="">
										...
										<p><small>Major : <b><?php echo $row['major'] ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_doctor" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-contact="<?php echo $row['contact'] ?>" data-address="<?php echo $row['address'] ?>"data-amount="<?php echo number_format($row['major'],2) ?>" >Edit</button>
...
<script>
	...
	$('.edit_doctor').click(function(){
		...
		cat.find("[name='major']").val($(this).attr('data-major'))
		end_load()
	})
