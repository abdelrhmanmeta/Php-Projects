					...
					<div class="modal fade" id="pay_modal" role='dialog'>
					    <div class="modal-dialog modal-md" role="document">
					      ...
					      <div class="modal-body">
							...
							<div class="form-group">
					      			<label for="" class="control-label">Discount value(hint: 0.00)</label>
					      			<input type="number" name="discountvalue" value="0" class="form-control text-right" >
					      		</div>
							<div class="form-group">
					      			<label for="" class="control-label">Tax value (hint: 0.00)</label>
					      			<input type="number" name="taxvalue" value="0"  class="form-control text-right" >
					      		</div>
					      		<div class="form-group">
...
<script>
	...
	$('[name="amount_tendered"]').keyup(function(){
			...
			// If tenderd paid is 0
			if (tendered == 0){
				// Get amount
				var tamount = original_total;
				var discount = $('[name="discountvalue"]').val();
				var tax = $('[name="taxvalue"]').val();
				// get the total after applying taxes and discounts
				var samount = (parseFloat(tamount)*parseFloat(discount));
				var xamount = (parseFloat(tamount)*parseFloat(tax));
				var famount = parseFloat(tamount)-parseFloat(samount)+parseFloat(xamount);
				// Finally set the total
				$('[name="tamount"]').val(parseFloat(famount))
				}
		})
