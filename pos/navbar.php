...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=doctor" class="nav-item nav-doctor"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Doctor List</a>
                <a href="index.php?page=reports" class="nav-item nav-reports"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Reports</a>
				<a href="index1.php?page=barcode"class="nav-item nav-barcode"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Barcode Generator</a>
                <a href="apsystem/index.php"class="nav-item nav-attendance"><span class='icon-field'><i class="fa fa-user-friends"></i></span> Attendance</a>
...
<?php if($_SESSION['login_type'] != 1): ?>
	<style>
		...
		.nav-sales ,.nav-barcode,.nav-home ,.nav-inventory , .nav-attendance {
