					...
					<div class="card-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
								...
								<select name="member_type" id="" class="custom-select browser-default">
							  	        <option value="Golden" selected="">Golden</option>
							  	        <option value="Silver" selected="">Silver</option>
							  	        <option value="Bronze" selected="">Bronze</option>
							  	        <option value="No member" selected="">No member</option>
								</select>
							</div>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
                                        ...
                                        <p><small>Member Type : <b><?php echo $row['member_type'] ?></b></small></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_customer" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-contact="<?php echo $row['contact'] ?>" data-address="<?php echo $row['address'] ?>"data-amount="<?php echo $row['amount'] ?>" data-category_id="<?php echo $row['member_type'] ?>" >Edit</button>
...
<script>
	...
	$('.edit_customer').click(function(){
        ...
        cat.find("[name='member_type']").val($(this).attr('data-member_type'))
		end_load()
	})
